...
func (c *leafClient) GenSegmentCache(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*SegmentBufferCacheViews, error) {
	out := new(SegmentBufferCacheViews)
	err := c.cc.Invoke(ctx, "/leafgrpc.v1.Leaf/GenSegmentCache", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *leafClient) GenSegmentDB(ctx context.Context, in *IDRequest, opts ...grpc.CallOption) (*LeafAllocDbs, error) {
	out := new(LeafAllocDbs)
	err := c.cc.Invoke(ctx, "/leafgrpc.v1.Leaf/GenSegmentDB", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLeafServer) GenSegmentCache(context.Context, *IDRequest) (*SegmentBufferCacheViews, error) {
...
func _Leaf_GenSegmentCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LeafServer).GenSegmentCache(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/leafgrpc.v1.Leaf/GenSegmentCache",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LeafServer).GenSegmentCache(ctx, req.(*IDRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Leaf_GenSegmentDB_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LeafServer).GenSegmentDB(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/leafgrpc.v1.Leaf/GenSegmentDB",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LeafServer).GenSegmentDB(ctx, req.(*IDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Leaf_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Leaf_GenSegmentCache_Handler,
		},
		{
